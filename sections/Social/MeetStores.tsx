    ...
    return (
        <div id={id} class="bg-[#F6F6F6] pt-[27px] pb-16 lg:py-[50px]">
            <div class="container lg:max-w-[82%] flex flex-col">
                <span class="font-sans text-[#4F4F4F] px-[18px] lg:px-0 mb-6 lg:mb-[30px] text-2xl">{title}</span>
                {/* Mobile view */}
                <div class="lg:hidden">
                ...
                <a class="btn bg-white rounded-none flex items-center justify-center mt-9 lg:mt-[53px] w-full max-w-[94%] md:max-w-[440px] min-h-[48px] mx-auto text-[#555555] font-semibold text-xs py-2 border-[1px] border-solid border-[#808080] text-center tracking-[0.1em] hover:bg-dimgray hover:text-white" href={cta?.href}>
