...
export default function CampaignPopup(props: Props) {
    ...
    return (<>
      <div id="modal" class="fixed inset-0 z-[99999999999] flex items-center justify-center">
        ...
        <div class="relative w-[90%] sm:w-[400px] h-[400px]">
          <a href={popup.link} class="w-full h-full">
            <Image src={popup.source} alt={popup.description} width={400} height={400} loading="lazy"/>
          </a>

          <button id="close-modal-btn" class="absolute top-2 right-2 text-white bg-black rounded-full p-2 hover:bg-gray-800 transition-all duration-200">
      ...
      <script type="module" dangerouslySetInnerHTML={{
            __html: useScript(handleCloseModal, "modal-popup", "closed", hoursToShowPopupAgain),
        }}/>
    </>);
}
