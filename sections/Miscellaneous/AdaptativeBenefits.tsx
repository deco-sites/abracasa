...
function MobileBenefits({ benefits, interval, infinite }: Props) {
    const id = useId();
    return (<div class="flex relative w-full bg-aprox-whitesmoke mx-auto font-sans">
...
export default function AdaptativeBenefits({ benefits = [] }: Props) {
    ...
    return (<div class="flex items-center justify-center w-full bg-aprox-whitesmoke font-sans">
