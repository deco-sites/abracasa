...
function CampaignTimer({
    ...
    return (
        <>
            <div style={{ background: `${backgroundHex}` }} class="bg-accent text-accent-content">
                <div class="container mx-auto flex flex-col lg:flex-row lg:items-center lg:justify-center lg:gap-16 py-4 px-6 gap-4 ">
                    ...
                    <div class="flex gap-8 lg:gap-16 items-center justify-center lg:justify-normal">
                        ...
                        <div
                            class={`hidden text-sm text-center lg:text-xl lg:text-left lg:max-w-lg ${layout?.textPosition === "After counter"
                                ? "lg:block"
                                : "lg:hidden"
                                }`}
                            dangerouslySetInnerHTML={{ __html: text }}
                        ...
                        <a
                            style={{ background: `${link.backgroundHexButton}` }}
                            class="btn"
                    ...
                    <div
                        class={`lg:hidden text-sm text-center lg:text-xl lg:text-left lg:max-w-lg ${layout?.textPosition === "After counter" ? "block" : "hidden"
                            }`}
                        dangerouslySetInnerHTML={{ __html: text }}
                    >
                    </div>
