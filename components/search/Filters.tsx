          ...
          return (
            <li class="flex flex-col gap-4 dropdown dropdown-end">
              <div
                ...
                tabIndex={0}
                role="button"
                class="flex items-center justify-center border rounded-[4px] px-1.5 h-[48px] text-sm leading-[22px] text-primary font-normal bg-transparent hover:bg-transparent m-1 gap-1.5 w-full"
              >
