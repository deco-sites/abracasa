...
function Sort(
  ...
  return (
    <select
      ...
      class="OrderPlp w-[145px] h-full rounded-[2px] text-base-content text-[13px] cursor-pointer outline-none px-0.5 py-[6px] lg:w-full lg:max-w-[134px] lg:px-[13px] lg:py-[14px]"
    >
