...
function Banner(props: SectionProps<ReturnType<typeof loader>>) {
    ...
    return (<div class="relative h-full overflow-y-hidden w-full">
      <Picture preload>
        <Source src={image.mobile} width={800} height={400} media="(max-width: 767px)"/>
        <Source src={image.desktop} width={1800} height={220} media="(min-width: 767px)"/>
        <img class="w-full object-cover" src={image.desktop} alt={image.alt ?? title}/>
      </Picture>
    </div>);
}
