...
export default function BannnerGrid(props: Props) {
  ...
  return (
    ...
    >
      ...
      <div
        class={`${
          banners.length === 1 && banners[0].literalWidth
            ? "flex justify-center mb-[104px]"
            : `grid gap-4 md:gap-6 mb-0 ${
          ...
          ({
            ...
            <a
              ...
              class={`overflow-hidden ${
                ...
                ${literalWidth ? "lg:pr-[20px]" : ""}`}
              style={
                literalWidth
                  ? {
                      maxWidth: widthDesktop ? `${widthDesktop}px` : undefined,
                    }
                  : {}
              }
            >
